...
#이부분을 수정할것
date = [20250205,20250206,20250207,20250212,20250213,20250214]  # 날짜 YYYYMMDD 형식으로 작성, 콤마로 구분
court = [1,1,1,1,1,1]  # 코트번호, 콤마로 구분
starttime = [10,10,10,10,10,10]  # 시작하는 시각을 24시간 형식(오후 1시 = 13)으로 작성, 콤마로 구분
